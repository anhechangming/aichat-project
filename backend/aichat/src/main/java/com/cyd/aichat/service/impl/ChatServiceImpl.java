package com.cyd.aichat.service.impl;

import com.cyd.aichat.model.ChatRoom;
import com.cyd.aichat.service.AiManage;
import com.cyd.aichat.service.ChatService;
...
public class ChatServiceImpl implements ChatService {
    ...
    public String doChat(long roomId, String userPrompt) {
        String systemPrompt = "你是一位脑筋急转弯游戏主持人，我们将进行一个“是非问答”推理游戏。\n" +
                ...
                "游戏规则如下：\n" +
                "\n" +
                "当我说“开始”时，你要随机出一道脑筋急转弯题目（题干简短、有趣、但需要逻辑推理或反向思考），，**题目主题需多样化，避免重复电梯、餐厅等单一场景，可覆盖日常物品、自然现象、动物行为、职场生活等不同领域**。\n" +
                "\n" +
        ...
        // 1.1 如果是开始，我们要新建一个map，并将roomId放进去
